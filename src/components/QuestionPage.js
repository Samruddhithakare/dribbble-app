...
import c3 from '../components/c3.png';
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-3 gap-8" style={{ width: '80vw', maxWidth: '960px' }}>
          ...
          <div className={`option-card border rounded-lg p-4 cursor-pointer flex flex-col border-gray-300 ${selectedOptions.includes(1) ? 'border-pink-600' : ''}`} onClick={() => handleOptionClick(1)}>
            <img src={c1} alt="c1" className={`mb-2 mx-auto w-full h-auto transition-transform transform ${selectedOptions.includes(1) ? '-translate-y-12' : ''}`} style={{ marginTop: selectedOptions.includes(1) ? '-4rem' : '0' }} />
          ...
          <img src={c2} alt="c2" className={`mb-2 mx-auto w-full transition-transform transform ${selectedOptions.includes(2) ? '-translate-y-12' : ''}`} style={{ marginTop: selectedOptions.includes(2) ? '-4rem' : '0', height: '178px' }} />
          ...
          <div className={`option-card border rounded-lg p-4 cursor-pointer flex flex-col border-gray-300 ${selectedOptions.includes(3) ? 'border-pink-600' : ''}`} onClick={() => handleOptionClick(3)}>
            <img src={c3} alt="c3" className={`mb-2 mx-auto w-full h-auto transition-transform transform ${selectedOptions.includes(3) ? '-translate-y-12' : ''}`} style={{ marginTop: selectedOptions.includes(3) ? '-4.5rem' : '0' }} />
            <div className="option-content flex-grow">
